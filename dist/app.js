...
level=level||sequence.length;speed=Math.floor(speed*1000)||1000;var game=this;var sequence=this.sequence;var animations=[];var _loop=function _loop(i){animations.push(new Promise(function(resolve,reject){setTimeout(function(){game.animateButton(sequence[i]).then(function(){resolve()})},speed*i)}))};for(var i=0;i<level;i++){_loop(i)}var res=Promise.all(animations);return res}};GAME.init();GAME.setupGame();
